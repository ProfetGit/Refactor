...
- **Auto-sell grey items** — Instantly vendor all junk items
...
- **Automatic repairs** — Repairs all gear when visiting a repair vendor
...
- **Ready checks** — Auto-accept ready checks
- **Summons** — Accept warlock/meeting stones instantly
...
- **Accept from friends** — Auto-accept party invites from your friend list
...
- **Context-aware** — Only works where you want it
- **PvP mode** — Auto-release in battlegrounds and arenas
...
- **Transmog status** — See if you've collected an appearance
  ...
  - Integrates with Baganator addon
- **Item/Spell IDs** — Display IDs for addon developers
- **Hide elements** — Remove guild names, PvP status, realms, factions
- **Compact mode** — Reduce tooltip size
- **Custom positioning** — Anchor tooltips to your mouse or screen corners
- **Adjustable scale** — Set your preferred tooltip size
...
| Command | Description |
|---------|-------------|
| `/refactor` | Open the settings panel |
| `/rf` | Shorthand for settings |
...
- **Slash command:** `/refactor` or `/rf`
- **Minimap button** — Click to open settings
- **ESC → Options → AddOns → Refactor**

Each module can be individually enabled/disabled with granular sub-options.
...
### CurseForge / WowUp
1. Search for "Refactor" in your addon manager
2. Click Install
3. Enable and enjoy!
...
3. Ensure the folder is named `Refactor`
...
- **WoW Retail:** The War Within (11.0+)
- **Addon Integrations:**
  - Baganator — Transmog icons work in Baganator bags
...
This addon is released under the MIT License. Feel free to modify and share!
