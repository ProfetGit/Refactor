...
addon.L = {
    ...
    TIP_SELL_KNOWN_TRANSMOG = "Sell soulbound equipment if you already have that appearance in your collection. Great for clearing old gear!",
    TIP_KEEP_TRANSMOG = "Never sell soulbound equipment if you haven't collected the appearance yet. Fashion first!",
    TIP_SELL_LOW_ILVL = "Sell soulbound equipment below the max iLvl threshold. Only works on SOULBOUND items - BoE items are NEVER sold.",
    TIP_MAX_ILVL = "Items with item level BELOW this value will be considered for selling. Items at or above this level are always kept. The addon also protects items equal to or higher than your lowest equipped piece.",
    ...
    TIP_USE_GUILD_FUNDS = "Attempt to use guild bank funds for repairs first. Falls back to personal gold if unavailable or insufficient.",
    ...
    TIP_TRANSMOG_OVERLAY = "Display a small icon on item buttons in bags and vendors showing if the appearance is collected.",
