...
| Maximum camera distance | Full | V |
...
| Feature | Notes | Tier | Risk |
|---|---|---|---|
| Copy chat | Click an icon, get selectable text | Standard | V |
...
| Rarity-coloured border | Border tinted to item quality. See 7.7.2. | Full | V |
